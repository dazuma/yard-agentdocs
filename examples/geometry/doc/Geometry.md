...
- **Defined in:** `examples/geometry/lib/geometry.rb`
...
- [`Cache`](Geometry/Cache.md) (private API) — An internal memoization cache used by a few computation-heavy methods elsewhere in this namespace.
